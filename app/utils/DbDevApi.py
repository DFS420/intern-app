import requests
from flask import Flask, Blueprint, current_app, Response, request, render_template, flash, redirect, url_for
...
def create_app():
    ...
    with db_dev_api.app_context():
        ...
        @db_dev_api.route("/dev/download_db/<type>", methods=['GET', 'POST'])
        ...
        @db_dev_api.route('/download_dev_db', methods=['GET', 'POST'])
        def download_dev_db():
            _type = request.args['type']
